...
function Terminal() {
  ...
  return (
    <section
      className={`developer-terminal theme-${themeName}`}
      style={terminalStyle}
    ...
    >
      ...
      <div className="dt-header">
        <div className="dt-window-controls" aria-hidden="true">
          <span className="dt-control dt-close" />
          <span className="dt-control dt-minimize" />
          <span className="dt-control dt-maximize" />
        </div>
