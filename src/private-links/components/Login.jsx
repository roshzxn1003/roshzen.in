...
import { Lock, Mail, KeyRound, AlertCircle, ShieldCheck, Loader2 } from 'lucide-react'
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1 font-mono">
            Protected LinkHub Admin Gateway
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-black/40 border border-white/10 focus:border-red-500 focus:outline-none text-sm text-white font-mono"
              />
            </div>
          </div>
